...
namespace GameofLifedanielT
{
...

    {
        ...
        Bitmap Zrosgen = Properties.Resources.Zrosgen;
        ...
        private void Labyrinth_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (Alive== true)
            {
                ...
                //        Gold = lab.Money2(panMain, panel, _row, _column, Gold);
                        ...
                        lab.Teleport(panMain, panel, _row, _column, Lvl);
                        ...
                        if (encounte > 0)
                        {
                            if (encounte == 1)
                            {
                                ...
                                Fight = lab.Fight(panMain, panel, _row, _column, Fight, sword, Armor, encounte, Bombs,Mana,Lvl, Schmuck);
                                if (Fight == true)
                                {
                                    if (sword > 0 && Armor > 0)
                                    {
                            ...
                            {
                                picnpc.BackgroundImage = Direwolf;
                                Fight = lab.Fight(panMain, panel, _row, _column, Fight, sword, Armor, encounte, Bombs, Mana, Lvl, Schmuck);
                                if (Fight == true)
                                {
                            ...
                            else if (encounte == 14)
                            {
                                ...
                                if (Fight == true)
                                {
                                    ...
                                    else if (BehemothResult == 3)
                                    {
                                       
                                        Fight = false;
                                        encounte = 0;
                                    }
                                    else if (BehemothResult == 4)
                                    {
                                        Gold = Gold + 10000;
                                        Fight = false;
                                        encounte = 0;
                        ...
                        if (Gold >= 100 && Btrade == true)
                        {
                            ...
                            Manaheal = lab.Manaheal(panMain, panel, _row, _column, Manaheal);
                            if (Manaheal == true && Gold >= 3000)
                            {
                                Mana = Spellpower;
                                Gold = Gold - 3000;
                                Manaheal = false;
                    ...
                    if (leverover == false)
                    {
                        ...
                        foreach (PictureBox panel in panMain.Controls)
                        {
                            ...
                            else if (Lvl == 9 && leverover == false && _row == 4 && _column == 2)
                            {
                                Respawn = 3;
                                lblrespawn.Text = Respawn.ToString();
                                _row = 4;
                            ...
                            else if (Lvl == 10 && leverover == false && _row == 3 && _column == 1)
                            {
                                Respawn = 3;
                                lblrespawn.Text = Respawn.ToString();
                                _row = 3;
        ...
        private void btnlvl9_Click(object sender, EventArgs e)
        {
            ...
            btnlvl9.Enabled = false;
            btnlvl9.Enabled = true;
            Lvl = 9;
            if (Gene == false)
            {
                Gene = true;
        ...
        private void btnlvl10_Click(object sender, EventArgs e)
        {
            ...
            btnlvl10.Enabled = false;
            btnlvl10.Enabled = true;
            Lvl = 10;
            if (Gene == false)
            {
                Gene = true;
